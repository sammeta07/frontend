  ...
  samitiGroups = [
    {
      ...
      totalEvents: 3,
      events: [
        { id: 101, title: 'Ganesh Utsav 2026', status: 'started', year_count: 5, start_date: '2026-09-15', end_date: '2026-09-25' },
    ...
    },
    {
      ...
      events: [
        ...
        { id: 204, title: 'Winter Charity Drive', status: 'started', year_count: 12, start_date: '2025-12-15', end_date: '2026-01-15' }
      ]
    },
    {
      ...
      totalEvents: 5,
      events: [
        { id: 301, title: 'Maha Shivratri Bhandara', status: 'started', year_count: 15, start_date: '2026-02-18', end_date: '2026-02-18' },
        { id: 302, title: 'Yoga Workshop', status: 'upcoming', year_count: 3, start_date: '2026-04-01', end_date: '2026-04-07' },
        { id: 303, title: 'Satsang Series', status: 'started', year_count: 7, start_date: '2026-01-01', end_date: '2026-12-31' },
        { id: 304, title: 'Temple Renovation', status: 'upcoming', year_count: 4, start_date: '2026-06-01', end_date: '2026-12-01' },
        { id: 305, title: 'Free Medical Checkup', status: 'started', year_count: 6, start_date: '2026-03-20', end_date: '2026-03-20' }
      ]
    },
    {
      ...
      totalEvents: 3,
      events: [
        { id: 401, title: 'Street Play (Nukkad)', status: 'started', year_count: 2, start_date: '2026-03-05', end_date: '2026-03-05' },
        { id: 402, title: 'Clean City Campaign', status: 'started', year_count: 5, start_date: '2026-01-10', end_date: '2026-06-10' },
    ...
    },
    {
      ...
      events: [
        ...
        { id: 502, title: 'Summer Coaching', status: 'started', year_count: 8, start_date: '2026-05-01', end_date: '2026-06-30' },
        { id: 503, title: 'Football Tournament', status: 'started', year_count: 6, start_date: '2026-04-10', end_date: '2026-04-20' },
    ...
    },
    {
      ...
      events: [
        ...
        { id: 602, title: 'Tree Adoption', status: 'started', year_count: 3, start_date: '2025-07-01', end_date: '2026-07-01' },
        { id: 603, title: 'Old Age Home Visit', status: 'started', year_count: 7, start_date: '2026-02-10', end_date: '2026-02-10' },
        ...
        { id: 606, title: 'Food Donation', status: 'started', year_count: 12, start_date: '2026-01-01', end_date: '2026-12-31' }
      ]
    },
    {
      ...
      totalEvents: 3,
      events: [
        { id: 701, title: 'Tribal Art Fest', status: 'started', year_count: 25, start_date: '2026-02-20', end_date: '2026-02-25' },
    ...
    },
    {
      ...
      totalEvents: 4,
      events: [
        { id: 801, title: 'Scholarship Exam', status: 'started', year_count: 10, start_date: '2026-01-15', end_date: '2026-03-15' },
        { id: 802, title: 'Winter Clothes Drive', status: 'started', year_count: 15, start_date: '2025-11-01', end_date: '2026-02-01' },
    ...
    },
    {
      ...
      totalEvents: 5,
      events: [
        { id: 901, title: 'Agri-Tech Seminar', status: 'started', year_count: 4, start_date: '2026-02-01', end_date: '2026-02-02' },
        { id: 902, title: 'Pond Cleaning', status: 'started', year_count: 8, start_date: '2026-03-01', end_date: '2026-03-05' },
    ...
    },
    {
      ...
      totalEvents: 3,
      events: [
        { id: 1001, title: 'Entrepreneurship Meet', status: 'started', year_count: 2, start_date: '2026-03-15', end_date: '2026-03-15' },
    ...
    },
    {
      ...
      totalEvents: 7,
      events: [
        { id: 1101, title: 'Eye Surgery Camp', status: 'started', year_count: 22, start_date: '2026-02-10', end_date: '2026-02-15' },
        { id: 1102, title: 'Women Empowerment Talk', status: 'started', year_count: 5, start_date: '2026-03-08', end_date: '2026-03-08' },
        ...
        { id: 1105, title: 'Organic Farming Intro', status: 'started', year_count: 4, start_date: '2026-04-22', end_date: '2026-04-22' },
        { id: 1106, title: 'Blood Group Testing', status: 'started', year_count: 8, start_date: '2026-05-10', end_date: '2026-05-10' },
        { id: 1107, title: 'Evening School Support', status: 'started', year_count: 10, start_date: '2026-01-01', end_date: '2026-12-31' }
      ]
    }
  ];
  onCreateSamiti() {
