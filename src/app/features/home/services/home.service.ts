...
export class HomeService {
  private apiUrl = 'http://localhost:3000/groups'; // Replace with your actual API endpoint
  ...
  samitiGroups: groupDetailsModel[] = [
    ...
    },
    {
      ...
      events: [
        ...
        { id: 202, title: 'Garba Night', year_count: 5, start_date: '2025-12-15', end_date: '2025-12-25', location: 'Community Hall', images: ['https://picsum.photos/seed/garba-night/800/500', 'https://picsum.photos/seed/garba-night-2/800/500'], description: 'Dance into the festive season with our vibrant Garba Night! This traditional circular dance celebrates the joy of togetherness. Come dressed in colorful attire to participate in group dances, enjoy music, and connect with the community in a fun and energetic atmosphere!' },
        { id: 203, title: 'Diwali Mela', year_count: 8, start_date: '2026-11-05', end_date: '2026-11-15', location: 'Civic Center', images: ['https://picsum.photos/seed/diwali-mela/800/500', 'https://picsum.photos/seed/diwali-mela-2/800/500'], description: 'Experience the festival of lights like never before! Our Diwali Mela is a grand celebration featuring food stalls, cultural performances, fireworks, and shopping. Families and friends gather to celebrate prosperity, happiness, and the victory of good over evil.' },
        { id: 204, title: 'Winter Charity Drive', year_count: 12, start_date: '2026-01-28', end_date: '2026-02-08', location: 'Station Road', images: ['https://picsum.photos/seed/winter-charity/800/500', 'https://picsum.photos/seed/winter-charity-2/800/500'], description: 'Spread warmth this winter! Our 12-year tradition of charity helps underprivileged families during the cold season. We collect and distribute blankets, warm clothes, and essentials. Your contribution can make a real difference in someone\'s life.' }
      ]
    },
    {
      id: 3,
      ...
      events: [
        ...
        { id: 302, title: 'Yoga Workshop', year_count: 3, start_date: '2026-04-01', end_date: '2026-04-12', location: 'Yoga Center', images: ['https://picsum.photos/seed/yoga-workshop/800/500', 'https://picsum.photos/seed/yoga-workshop-2/800/500'], description: 'Achieve wellness and inner peace through guided yoga sessions! Our expert instructors will teach you traditional asanas, pranayama, and meditation techniques. Perfect for beginners and experienced practitioners alike.' },
        { id: 303, title: 'Satsang Series', year_count: 7, start_date: '2026-01-20', end_date: '2026-02-04', location: 'Satsang Bhawan', images: ['https://picsum.photos/seed/satsang-series/800/500', 'https://picsum.photos/seed/satsang-series-2/800/500'], description: 'Join our 7-year tradition of spiritual gatherings! Satsang brings together people for meaningful discussions, devotional singing, and spiritual teachings. A unique opportunity to explore inner consciousness and connect with like-minded seekers.' },
        { id: 304, title: 'Temple Renovation', year_count: 4, start_date: '2026-06-01', end_date: '2026-06-10', location: 'Old Temple', images: ['https://picsum.photos/seed/temple-renovation/800/500', 'https://picsum.photos/seed/temple-renovation-2/800/500'], description: 'Be part of preserving our heritage! Help us restore and beautify the historic temple through community participation. Every contribution, big or small, helps preserve the cultural and spiritual significance of this sacred place.' },
        { id: 305, title: 'Free Medical Checkup', year_count: 6, start_date: '2026-01-29', end_date: '2026-02-09', location: 'Health Clinic', images: ['https://picsum.photos/seed/free-medical-checkup/800/500', 'https://picsum.photos/seed/free-medical-checkup-2/800/500'], description: 'Your health matters! Our free medical camp provides comprehensive health examinations, consultations, and basic treatments. Qualified doctors and healthcare professionals are available for everyone in the community.' }
      ]
    },
    {
      id: 4,
      ...
      events: [
        ...
        { id: 402, title: 'Clean City Campaign', year_count: 5, start_date: '2026-01-25', end_date: '2026-02-08', location: 'City Squares', images: ['https://picsum.photos/seed/clean-city/800/500', 'https://picsum.photos/seed/clean-city-2/800/500'], description: 'Make our city cleaner and greener! Join our 5-year initiative to clean public spaces, remove litter, and promote environmental awareness. Together, we create a healthier and more beautiful city for everyone.' },
        { id: 403, title: 'Plantation Drive', year_count: 9, start_date: '2026-07-01', end_date: '2026-07-15', location: 'River Bank', images: ['https://picsum.photos/seed/plantation-drive/800/500', 'https://picsum.photos/seed/plantation-drive-2/800/500'], description: 'Plant trees and grow the future! Our plantation drive aims to increase green cover and combat climate change. Join us in planting thousands of trees along the river bank and witness your contribution to environmental conservation.' }
      ]
    },
    {
      id: 5,
      ...
      events: [
        ...
        { id: 502, title: 'Summer Coaching', year_count: 8, start_date: '2026-01-22', end_date: '2026-02-05', location: 'School Ground', images: ['https://picsum.photos/seed/summer-coaching/800/500', 'https://picsum.photos/seed/summer-coaching-2/800/500'], description: 'Empower students for success! Our summer coaching program provides academic support in key subjects. Expert tutors help students strengthen fundamentals and prepare for exams. Make the most of your summer break!' },
        { id: 503, title: 'Football Tournament', year_count: 6, start_date: '2026-01-24', end_date: '2026-02-07', location: 'Sports Complex', images: ['https://picsum.photos/seed/football-tournament/800/500', 'https://picsum.photos/seed/football-tournament-2/800/500'], description: 'Goal! Experience the thrill of competitive football! Our tournament brings together talented players for intense matches, thrilling goals, and team spirit. Support your favorite teams and enjoy this exciting sporting extravaganza!' },
        { id: 504, title: 'Cyber Security Seminar', year_count: 1, start_date: '2026-08-05', end_date: '2026-08-10', location: 'College Auditorium', images: ['https://picsum.photos/seed/cyber-security/800/500', 'https://picsum.photos/seed/cyber-security-2/800/500'], description: 'Protect yourself in the digital age! Learn about cyber threats, data protection, and online safety from industry experts. This inaugural seminar equips you with essential cybersecurity knowledge for the modern world.' }
      ]
    },
    {
      id: 6,
      ...
      events: [
        ...
        { id: 602, title: 'Tree Adoption', year_count: 3, start_date: '2026-01-26', end_date: '2026-02-06', location: 'City Parks', images: ['https://picsum.photos/seed/tree-adoption/800/500', 'https://picsum.photos/seed/tree-adoption-2/800/500'], description: 'Become a tree guardian! Adopt a tree and help nurture it for years to come. Your adoption supports environmental conservation and creates green spaces for the community. Track your tree\'s growth and make a lasting impact!' },
        { id: 603, title: 'Old Age Home Visit', year_count: 7, start_date: '2026-01-28', end_date: '2026-02-07', location: 'Old Age Home', images: ['https://picsum.photos/seed/old-age-home/800/500', 'https://picsum.photos/seed/old-age-home-2/800/500'], description: 'Bring joy to seniors! Our care visits provide companionship, assistance, and love to elderly residents. Share stories, play games, and spend meaningful time with people who appreciate interaction. Make a difference one visit at a time!' },
        { id: 604, title: 'Digital Literacy Camp', year_count: 2, start_date: '2026-09-01', end_date: '2026-09-12', location: 'Community Center', images: ['https://picsum.photos/seed/digital-literacy/800/500', 'https://picsum.photos/seed/digital-literacy-2/800/500'], description: 'Bridge the digital divide! Learn essential computer and internet skills. Our camp teaches basic computer operations, email, online safety, and digital tools. Perfect for those new to technology and wanting to stay connected.' },
        { id: 605, title: 'Handicraft Exhibition', year_count: 5, start_date: '2026-10-02', end_date: '2026-10-10', location: 'Exhibition Ground', images: ['https://picsum.photos/seed/handicraft-exhibition/800/500', 'https://picsum.photos/seed/handicraft-exhibition-2/800/500'], description: 'Celebrate local artistry! Showcase traditional and contemporary handicrafts from talented artisans. Visitors can view, purchase, and support local craftspeople. A perfect blend of art, culture, and commerce!' },
        { id: 606, title: 'Food Donation', year_count: 12, start_date: '2026-01-20', end_date: '2026-02-04', location: 'Slum Area', images: ['https://picsum.photos/seed/food-donation/800/500', 'https://picsum.photos/seed/food-donation-2/800/500'], description: 'Feed the hungry! Our 12-year food donation drive ensures no one goes hungry. We collect and distribute nutritious meals to underprivileged families and individuals. Every meal is prepared with care and served with compassion.' }
      ]
    },
    {
      id: 7,
      ...
      events: [
        ...
        { id: 702, title: 'Photography Contest', year_count: 4, start_date: '2026-08-19', end_date: '2026-08-30', location: 'Online', images: ['https://picsum.photos/seed/photography-contest/800/500', 'https://picsum.photos/seed/photography-contest-2/800/500'], description: 'Capture moments, win recognition! Photographers of all levels can submit their best work. Categories include nature, culture, portraits, and abstracts. Showcase your creative vision and compete for prizes and publication!' },
        { id: 703, title: 'Local Music Night', year_count: 6, start_date: '2026-11-14', end_date: '2026-11-20', location: 'Music Hall', images: ['https://picsum.photos/seed/local-music-night/800/500', 'https://picsum.photos/seed/local-music-night-2/800/500'], description: 'Feel the rhythm of local talent! Our music nights feature local musicians and bands performing diverse genres. From traditional to contemporary, this is a platform for musical expression and community entertainment.' }
      ]
    },
    {
      id: 8,
      ...
      events: [
        ...
        { id: 802, title: 'Winter Clothes Drive', year_count: 15, start_date: '2026-01-25', end_date: '2026-02-08', location: 'City Square', images: ['https://picsum.photos/seed/winter-clothes/800/500', 'https://picsum.photos/seed/winter-clothes-2/800/500'], description: 'Warm hearts in winter! Donate winter clothing and blankets to those in need. Our 15-year drive has helped thousands stay warm during harsh winters. Every contribution directly reaches vulnerable populations.' },
        { id: 803, title: 'Library Setup', year_count: 2, start_date: '2026-06-01', end_date: '2026-06-15', location: 'Village Library', images: ['https://picsum.photos/seed/library-setup/800/500', 'https://picsum.photos/seed/library-setup-2/800/500'], description: 'Open doors to knowledge! Help us establish and stocked village libraries offering free access to books and learning resources. Be part of spreading education and literacy in underserved communities.' },
        { id: 804, title: 'Skill Training', year_count: 3, start_date: '2026-09-05', end_date: '2026-09-18', location: 'Training Center', images: ['https://picsum.photos/seed/skill-training/800/500', 'https://picsum.photos/seed/skill-training-2/800/500'], description: 'Build a better future! Our vocational skill training programs teach marketable skills from tailoring to digital marketing. Trainees gain certification and job placement assistance to secure sustainable livelihoods.' }
      ]
    },
    {
      id: 9,
      ...
      events: [
        ...
        { id: 902, title: 'Pond Cleaning', year_count: 8, start_date: '2026-01-28', end_date: '2026-02-05', location: 'Village Pond', images: ['https://picsum.photos/seed/pond-cleaning/800/500', 'https://picsum.photos/seed/pond-cleaning-2/800/500'], description: 'Preserve water resources! Join us in cleaning and maintaining village ponds. This community effort ensures clean water availability for agriculture and daily use, while promoting environmental conservation.' },
        { id: 903, title: 'Village Sports Day', year_count: 12, start_date: '2026-04-14', end_date: '2026-04-24', location: 'School Ground', images: ['https://picsum.photos/seed/village-sports/800/500', 'https://picsum.photos/seed/village-sports-2/800/500'], description: 'Celebrate health through sports! Our annual sports day brings the entire village together for friendly competitions, team events, and celebration of fitness. All ages participate in traditional and modern sports.' },
        { id: 904, title: 'Sanitation Awareness', year_count: 5, start_date: '2026-01-02', end_date: '2026-01-10', location: 'Village Streets', images: ['https://picsum.photos/seed/sanitation-awareness/800/500', 'https://picsum.photos/seed/sanitation-awareness-2/800/500'], description: 'Health through cleanliness! Our awareness drive educates communities about importance of sanitation and hygiene. We promote waste management, toilet usage, and cleanliness habits for better health.' },
        { id: 905, title: 'Cattle Health Camp', year_count: 3, start_date: '2026-05-20', end_date: '2026-05-30', location: 'Veterinary Hospital', images: ['https://picsum.photos/seed/cattle-health/800/500', 'https://picsum.photos/seed/cattle-health-2/800/500'], description: 'Healthy livestock = Healthy farmers! Free veterinary services for cattle including vaccinations, health checkups, and treatment. Healthy animals ensure better productivity and farmer prosperity.' }
      ]
    },
    {
      id: 10,
      ...
      events: [
        ...
        { id: 1002, title: 'Career Counselling', year_count: 4, start_date: '2026-05-01', end_date: '2026-05-08', location: 'School Auditorium', images: ['https://picsum.photos/seed/career-counselling/800/500', 'https://picsum.photos/seed/career-counselling-2/800/500'], description: 'Shape your professional journey! Professional counselors guide students in career planning and decision-making. Explore various career paths, college options, and skill development opportunities.' },
        { id: 1003, title: 'Youth Icon Awards', year_count: 1, start_date: '2026-08-12', end_date: '2026-08-20', location: 'Town Hall', images: ['https://picsum.photos/seed/youth-icon-awards/800/500', 'https://picsum.photos/seed/youth-icon-awards-2/800/500'], description: 'Recognize youth excellence! Our inaugural awards ceremony celebrates outstanding young leaders making positive changes in society. Be inspired by role models and aspire to greatness!' }
      ]
    },
    {
      id: 11,
      ...
      events: [
        ...
        { id: 1102, title: 'Women Empowerment Talk', year_count: 5, start_date: '2026-01-28', end_date: '2026-02-05', location: 'Community Hall', images: ['https://picsum.photos/seed/women-empowerment/800/500', 'https://picsum.photos/seed/women-empowerment-2/800/500'], description: 'Empower women, empower society! Inspiring talks on women\'s rights, education, health, and professional development. Successful women leaders share their journeys and motivate the next generation.' },
        { id: 1103, title: 'Cycle Marathon', year_count: 3, start_date: '2026-06-05', end_date: '2026-06-12', location: 'Main Road', images: ['https://picsum.photos/seed/cycle-marathon/800/500', 'https://picsum.photos/seed/cycle-marathon-2/800/500'], description: 'Pedal for a cause! Our cycle marathon promotes fitness, environmental awareness, and community bonding. Join families and friends for a healthy ride through the city streets.' },
        { id: 1104, title: 'Legal Aid Workshop', year_count: 2, start_date: '2026-07-15', end_date: '2026-07-22', location: 'Law College', images: ['https://picsum.photos/seed/legal-aid/800/500', 'https://picsum.photos/seed/legal-aid-2/800/500'], description: 'Know your rights! Free legal workshops educate people about constitutional rights, consumer laws, and justice processes. Empower yourself with legal knowledge and access to justice.' },
        { id: 1105, title: 'Organic Farming Intro', year_count: 4, start_date: '2026-01-25', end_date: '2026-02-04', location: 'Farm House', images: ['https://picsum.photos/seed/organic-farming/800/500', 'https://picsum.photos/seed/organic-farming-2/800/500'], description: 'Farm chemical-free! Learn organic farming techniques that boost soil health and eliminate harmful pesticides. Discover how to produce nutritious food while protecting the environment.' },
        { id: 1106, title: 'Blood Group Testing', year_count: 8, start_date: '2026-01-30', end_date: '2026-02-08', location: 'Red Cross', images: ['https://picsum.photos/seed/blood-group-testing/800/500', 'https://picsum.photos/seed/blood-group-testing-2/800/500'], description: 'Know your blood group, save lives! Free blood group testing camps help people understand their blood type and contribute to blood banks. Essential for emergencies and medical situations.' },
        { id: 1107, title: 'Evening School Support', year_count: 10, start_date: '2026-01-20', end_date: '2026-02-04', location: 'Local School', images: ['https://picsum.photos/seed/evening-school/800/500', 'https://picsum.photos/seed/evening-school-2/800/500'], description: 'Education for all, even after sunset! Our 10-year evening school program supports working children and adults in completing their education. Quality learning with flexible schedules for everyone.' }
      ]
    },
    {
      id: 12,
